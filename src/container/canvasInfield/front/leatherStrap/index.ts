import { webTop, webTop2 } from 'src/container/canvasInfield/front/leatherStrap/webTop'
import { thumbInner } from 'src/container/canvasInfield/front/leatherStrap/thumbInner'
import { littleInner } from 'src/container/canvasInfield/front/leatherStrap/littleInner'
import { underWeb } from 'src/container/canvasInfield/front/leatherStrap/underWeb'
import { bank, bank2 } from 'src/container/canvasInfield/front/leatherStrap/bank'
import {
  indexWrapBack,
  indexTopOver,
  indexTop
} from 'src/container/canvasInfield/front/leatherStrap/connectIndexToWeb'
import {
  thumbWrapBack,
  thumbTopOver,
  thumbTop
} from 'src/container/canvasInfield/front/leatherStrap/connectThumbToWeb'
import { knotUpward, knotDownward } from 'src/container/canvasInfield/front/leatherStrap/knotSingle'
import {
  connectIndexToMiddle,
  connectMiddleToRing,
  connectRingToLittle
} from 'src/container/canvasInfield/front/leatherStrap/fingerTop'
import { thumbUpper, thumbUpper2 } from 'src/container/canvasInfield/front/leatherStrap/thumbUpper'
import { littleUpper } from 'src/container/canvasInfield/front/leatherStrap/littleUpper'
import { toji } from 'src/container/canvasInfield/front/leatherStrap/toji'
import {
  onEdgeTojiCenter,
  onEdgeTojiThumb,
  onEdgeTojiLittle,
  onEdgeTojiLittle2
} from 'src/container/canvasInfield/front/leatherStrap/onEdgeToji'
import {
  hWebCrossUpperLeft,
  hWebCrossUpperRight,
  hWebCrossUpperLeft2
} from 'src/container/canvasInfield/front/leatherStrap/hWebCross'
