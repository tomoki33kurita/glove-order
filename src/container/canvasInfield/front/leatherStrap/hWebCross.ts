export const hWebCrossUpperLeft = (ctx: CanvasRenderingContext2D, color: string): void => {
  ctx.lineWidth = 1.5
...
export const hWebCrossUpperRight = (ctx: CanvasRenderingContext2D, color: string): void => {
  ctx.lineWidth = 1.5
  ctx.strokeStyle = '#383838'
  ctx.fillStyle = color
  // 長方形＿巻き込みパーツ＿
...
export const hWebCrossUpperLeft2 = (ctx: CanvasRenderingContext2D, color: string): void => {
  ctx.lineWidth = 1.5
  ctx.strokeStyle = '#383838'
  ctx.fillStyle = color
  // 長方形＿巻き込みパーツ＿
