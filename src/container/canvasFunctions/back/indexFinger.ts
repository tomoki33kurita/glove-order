export const indexRight = (ctx: CanvasRenderingContext2D, color: string): void => {
  ...
  ctx.fillStyle = color
  ctx.beginPath()
  ctx.moveTo(520, 20) // 左上
  ctx.quadraticCurveTo(427, 170, 407, 356) // 左下
  ...
  ctx.quadraticCurveTo(537, 21, 520, 20) 
  ctx.stroke()
  ctx.fill()
  ctx.closePath()
}
...
export const indexLeft = (ctx: CanvasRenderingContext2D, color: string): void => {
  ...
  ctx.fillStyle = color
  ctx.beginPath()
  ctx.moveTo(510, 22) // 右上
  ctx.quadraticCurveTo(486, 22, 470, 41) 
  ctx.quadraticCurveTo(380, 177, 377, 360) // 左下 
  ctx.quadraticCurveTo(400, 357, 400, 357) // 右下 
  ctx.quadraticCurveTo(421, 170, 510, 22) // 右下 
  ctx.stroke()
  ctx.fill()
  ctx.closePath()
